...
export class GanttProjectController {
  ...
  async create(
    ...
    try {
      ...
      const createdProject = await this.ganttProjectService.createGanttProject(
        project,
        auth.id,
      );
  ...
  async findOne(
    ...
    try {
      ...
      const project = await this.ganttProjectService.getGanttProjectById(
        id,
        auth.id,
      );
  ...
  async remove(
    ...
    try {
      ...
      const project = await this.ganttProjectService.deleteGanttProject(
        id,
        auth.id,
      );
